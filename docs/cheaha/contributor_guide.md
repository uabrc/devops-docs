...
- [Create a new issue](https://github.com/uabrc/devops-docs.github.io/issues/new/choose)
...
If you need assistance, please feel free to [contact us](https://docs.rc.uab.edu/help/support/#how-to-request-support).
...
We assume you have a `conda` distribution on your local machine. If you are affiliated with UAB, please install [Miniforge](https://conda-forge.org/miniforge/). For detailed installation instructions, see here: <https://github.com/conda-forge/miniforge/?tab=readme-ov-file#install>. For more information on using `conda`, see our [Anaconda page](https://docs.rc.uab.edu/workflow_solutions/using_anaconda/#anaconda).
...
- [Stage and commit](https://docs.rc.uab.edu/workflow_solutions/git/#staging-and-committing-changes) changes in small units as you go.
- Be sure you are on the correct [branch](https://docs.rc.uab.edu/workflow_solutions/git/#how-do-i-manage-branches), i.e. your working branch!
...
1. [Activate](https://docs.rc.uab.edu/workflow_solutions/using_anaconda/#activate-an-environment) your conda environment.
...
1. [Push](https://docs.rc.uab.edu/workflow_solutions/git/#pushing) your local working branch to your GitHub remote repository.
...
[Add the Upstream Remote](https://docs.rc.uab.edu/workflow_solutions/git/#managing-remotes) using `git remote add upstream https://github.com/uabrc/uabrc.github.io.git`.

### Pull the pull request

1. [Fetch](https://docs.rc.uab.edu/workflow_solutions/git/#fetching-and-pulling) the pull request with `git fetch upstream pull/<id>/head:<branch-name>`.
...
2. [Checkout](https://docs.rc.uab.edu/workflow_solutions/git/#checking-out-existing-branches) the branch using `git checkout <branch-name>`.
...
4. (Optional) make modifications to the pull request.
    ...
    2. [Add the Author's Fork as a Remote](https://docs.rc.uab.edu/workflow_solutions/git/#managing-remotes).
    3. [Push changes to the Author's Fork](https://docs.rc.uab.edu/workflow_solutions/git/#pushing). Be sure to push to the correct remote!
